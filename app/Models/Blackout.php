...
class Blackout extends Model
{
    ...
    public function getRepeattextAttribute()
    {
        if ($this->repeat_type == 0) {
            ...
            $days = "";
            if (strpos($this->repeat_detail, "1") !== false) {
                $days = $days . "M";
            }
            if (strpos($this->repeat_detail, "2") !== false) {
                $days = $days . "T";
            }
            if (strpos($this->repeat_detail, "3") !== false) {
                $days = $days . "W";
            }
            if (strpos($this->repeat_detail, "4") !== false) {
                $days = $days . "U";
            }
            if (strpos($this->repeat_detail, "5") !== false) {
                $days = $days . "F";
            }
