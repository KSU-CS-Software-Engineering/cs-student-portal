...
class CompletedcoursesController extends Controller
{
    public function getCompletedcourses(Request $request, $id = -1)
    {
        if ($id < 0) {
            ...
            return view('dashboard.completedcourses')
                ->with('completedcourses', $completedcourses)
                ->with('page_title', "Completed Courses");
        } else {
            ...
            return view('dashboard.completedcourseedit')
                ->with('completedcourse', $completedcourse)
                ->with('page_title', "Edit Completed Course")
    ...
    public function getNewcompletedcourse()
    {
        ...
        return view('dashboard.completedcourseedit')
            ->with('completedcourse', $completedcourse)
            ->with('page_title', "New Completed Course")
            ->with('semesters', $semesters);
    }
