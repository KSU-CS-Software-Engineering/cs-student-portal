    ...
    public function getIndex(Request $request)
    {
        ...
        if ($user->is_advisor) {
            ...
            if ($request->session()->has('lastUrl')) {
                return view('profiles/advisorindex')
                    ->with('advisor', $user->advisor)
                    ->with('lastUrl', $request->session()->get('lastUrl'));
            } else {
            ...
            if ($request->session()->has('lastUrl')) {
                return view('profiles/index')->with('student', $user->student)->with('lastUrl', $request->session()
                    ->get('lastUrl'));
            } else {
