...
class PostDeploy extends Command
{
    ...
    public function handle()
    {
        ...
        $editables = Editable::where('controller', 'GroupsessionController')
            ->where('action', 'getIndex')
            ->where('key', 'head')
            ->where('version', 0)
            ->get();
  ...
  <div class="panel panel-primary">
    ...
    <div class="panel-body">
      <ul>
        ...
        $editables = Editable::where('controller', 'AdvisingController')
            ->where('action', 'getIndex')
            ->where('key', 'message')
            ->where('version', 0)
            ->get();
        ...
        $editables = Editable::where('controller', 'RootRouteController')
            ->where('action', 'getIndex')
            ->where('key', 'header')
            ->where('version', 0)
            ->get();
